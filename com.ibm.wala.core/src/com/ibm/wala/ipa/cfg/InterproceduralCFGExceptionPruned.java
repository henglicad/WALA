 ...
 */
public class InterproceduralCFGExceptionPruned extends AbstractInterproceduralCFG<ISSABasicBlock> {

  public InterproceduralCFGExceptionPruned(CallGraph CG) {
    super(CG);
  }

  public InterproceduralCFGExceptionPruned(CallGraph cg, Filtersection<CGNode> filtersection) {
  ...
  public ControlFlowGraph<SSAInstruction, ISSABasicBlock> getCFG(CGNode n) throws IllegalArgumentException {
    ...
    ControlFlowGraph<SSAInstruction, ISSABasicBlock> cfg = ExceptionPrunedCFG.make(n.getIR().getControlFlowGraph());
    if (cfg == null) {
      return null;
    }
